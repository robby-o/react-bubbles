...
<!-- the token is unique to the user and stored on the computer in local storage.  It provides 'private' access that would be unavailable without this authentication token -->

- [ ] What steps can you take in your web apps to keep your data secure?

<!-- use something like web tokens. require users to have difficult passwords.
     use the appropriate and most up to date web protocols such as HTTPS
 -->

- [ ] Describe how web servers work.

<!-- a web server handles the network requests that a client would make so they could access the web page
    it uses a protocol language known as HTTP so that the requests are standardized and secure
 -->
